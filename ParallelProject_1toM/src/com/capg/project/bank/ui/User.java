		...
		while (true) 
		{
			...
			case 1:
				...
				do 
				{
					...
					{
						System.err.println("Invalid... Omly 10 characters (alphanumeric) are allowed - Cap!!!");
						temp=false;
					}
				} while (temp == false);
			...
			case 2:
				...
				if(bean1 != null)
					System.out.println("Balance is Rs."+bean1.getBalance());
				else 
				{
					try 
					{
			...
			case 4: 
				...
				else
				{
					...
					catch (AccountException e)
					{
						...
						System.out.println(e.getMessage() + "  Not sufficient balance");
					}
				}
			...
			case 6:
				...
				System.out.println("\n\n--------------------------------------------------------------------------------------------------------------------------------------------------------");
				System.out.println(" Date\t   Time\t       A/C No.\t\tDetails\t\t\t\t\t\t\t\tCredit\tDebit\t\tBalance");
				System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------------------");
				try {
					...
					{
						System.out.println(passbook.getTransactionDetails()+"\t\t\t"+passbook.getCredit()+"\t\t"+passbook.getDebit()+"\t\t"+passbook.getBalance());
					}
					}
					else
					{
						System.err.println("Account number or Pin mismatch !!!");
					}
